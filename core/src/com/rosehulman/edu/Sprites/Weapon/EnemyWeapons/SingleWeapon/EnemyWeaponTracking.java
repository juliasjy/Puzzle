...
public class EnemyWeaponTracking extends SingleWeapon {

    public EnemyWeaponTracking(Vector2 position, Vector2 direction, World world, GameObject owner, PlayScreen sc) {
